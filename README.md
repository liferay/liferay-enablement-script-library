...
1. Open your terminal and run this command according to your operating system:
   ...
   **Windows**:
   ```bash
   powershell Set-ExecutionPolicy Bypass -Scope Process -Force; iex "& { $(irm https://raw.githubusercontent.com/liferay/liferay-enablement-script-library/main/install-liferay-enablement-content-manager-setup.ps1) }"
   ```
